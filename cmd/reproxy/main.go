...
var (
	...
	racingBias                = flag.Float64("racing_bias", 0.75, "Value between [0,10] to indicate how racing manages the tradeoff of saving bandwidth (0) versus speed (10). The default is to prefer speed over bandwidth.")
