...
#ifndef INTERNAL_PKG_SCANDEPS_CSDUTILS_ADJUST_CMD_H_
#define INTERNAL_PKG_SCANDEPS_CSDUTILS_ADJUST_CMD_H_
#include <set>
#include <string>
#include <vector>
...
#endif  // INTERNAL_PKG_SCANDEPS_CSDUTILS_ADJUST_CMD_H_