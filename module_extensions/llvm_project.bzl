...
def _llvm_project_impl(ctx):
    http_archive(
        ...
        sha256 = "cfc2bf43a8faa8156bf804315dfd70f9bb6cb1dec43377db71f4f1180cab56d5",
        strip_prefix = "zlib-ng-2.3.1",
        urls = [
            "https://github.com/zlib-ng/zlib-ng/archive/refs/tags/2.3.1.zip",
        ],
    )
    http_archive(
        name = "llvm_zstd",
