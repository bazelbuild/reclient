...
def _llvm_project_impl(ctx):
    http_archive(
        ...
        sha256 = "01e1a69a79546a514129043381879aa2c737617edbf4d2d786ea14d740e7bc20",
        strip_prefix = "zlib-ng-2.2.1",
        urls = [
            "https://github.com/zlib-ng/zlib-ng/archive/refs/tags/2.2.1.zip",
        ],
    )
    http_archive(
        name = "llvm_zstd",
