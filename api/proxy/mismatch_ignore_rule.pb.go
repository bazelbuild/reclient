...
var file_api_proxy_mismatch_ignore_rule_proto_goTypes = []interface{}{
...
func file_api_proxy_mismatch_ignore_rule_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_proxy_mismatch_ignore_rule_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_proxy_mismatch_ignore_rule_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Rule); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_proxy_mismatch_ignore_rule_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_proxy_mismatch_ignore_rule_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_api_proxy_mismatch_ignore_rule_proto_msgTypes[1].OneofWrappers = []interface{}{
